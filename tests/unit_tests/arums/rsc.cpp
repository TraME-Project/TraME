...
int main()
{
    ...
    trame::arums::rsc arum_obj(zeta,2.0,2.0);
    trame::arums::rsc arum_obj2(zeta,true);
    trame::arums::rsc arum_obj3(nbX,nbY);

    arum_obj.build_beta(zeta,2.0,2.0);
    arum_obj2.build(zeta,true);
    arum_obj3.build(nbX,nbY);

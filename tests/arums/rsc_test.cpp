 ...
 *
 * g++-mp-5 -O2 -Wall -std=c++11 -I/opt/local/include -I/opt/local/include/trame -I/usr/local/include rsc_test.cpp -o rsc.test -L/opt/local/lib -ltrame -framework Accelerate
 */

...
trame::arums::empirical
trame::arums::rusc::simul(const int n_draws, const int seed)
const
{
    empirical emp_obj;
...
void
trame::arums::rusc::simul(empirical& obj_out, const int n_draws, const int seed)
const
{
...
void
trame::arums::rusc::simul_int(empirical& obj_out, const int* n_draws_inp, const int* seed_val)
const
{
    int n_draws = 0;

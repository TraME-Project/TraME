...
// clang -O2 -Wall -I/opt/local/include -I/Library/gurobi650/mac64/include dense_c.c -o dense_c.test -L/Library/gurobi650/mac64/lib -lgurobi65 -framework Accelerate

...
arma::mat trame::transfers::ltu::M(const arma::mat& a_xs, const arma::mat& b_ys)
const
{
...
arma::mat trame::transfers::ltu::M(const arma::mat& a_xs, const arma::mat& b_ys, arma::uvec* xs, arma::uvec* ys)
const
{
...
arma::mat trame::transfers::ltu::M(const double& a_xs, const arma::mat& b_ys, arma::uvec* xs, arma::uvec* ys)
const
{
...
arma::mat trame::transfers::ltu::M(const arma::mat& a_xs, const double& b_ys, arma::uvec* xs, arma::uvec* ys)
const
{
    arma::uvec x_ind = (xs) ? *xs : uvec_linspace(0, (int) nbX-1); 
    arma::uvec y_ind = (ys) ? *ys : uvec_linspace(0, (int) nbY-1);
...
arma::mat trame::transfers::ltu::Mx0(const arma::mat& a_x)
const
{
    return a_x;
}

arma::mat trame::transfers::ltu::M0y(const arma::mat& b_y)
const
{
    return b_y;
}

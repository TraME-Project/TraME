...
void trame::ltu::build(const arma::mat& lambda_LTU, const arma::mat& phi_LTU, bool need_norm_LTU)
{
...
arma::mat trame::ltu::M(const arma::mat& a_xs, const arma::mat& b_ys)
const
{
...
arma::mat trame::ltu::M(const arma::mat& a_xs, const arma::mat& b_ys, arma::uvec* xs, arma::uvec* ys)
const
{
...
arma::mat trame::ltu::M(const double& a_xs, const arma::mat& b_ys, arma::uvec* xs, arma::uvec* ys)
const
{
...
arma::mat trame::ltu::M(const arma::mat& a_xs, const double& b_ys, arma::uvec* xs, arma::uvec* ys)
const
{
    arma::uvec x_ind = (xs) ? *xs : uvec_linspace(0, (int) nbX-1); 
    arma::uvec y_ind = (ys) ? *ys : uvec_linspace(0, (int) nbY-1);
...
arma::mat trame::ltu::Mx0(const arma::mat& a_x)
const
{
    return a_x;
}

arma::mat trame::ltu::M0y(const arma::mat& b_y)
const
{
    return b_y;
}
...
arma::mat trame::ltu::Psi(const arma::mat& U, const arma::mat& V)
const
{
...
arma::mat trame::ltu::Psi(const double& U, const arma::mat& V, arma::uvec* xs, arma::uvec* ys)
const
{
    arma::uvec x_ind = (xs) ? *xs : uvec_linspace(0, nbX-1);
    arma::uvec y_ind = (ys) ? *ys : uvec_linspace(0, nbY-1);
...
arma::mat trame::ltu::Psi(const arma::mat& U, const double& V, arma::uvec* xs, arma::uvec* ys)
const
{
    arma::uvec x_ind = (xs) ? *xs : uvec_linspace(0, nbX-1);
    arma::uvec y_ind = (ys) ? *ys : uvec_linspace(0, nbY-1);
...
double trame::ltu::Psi(const double& U, const double& V, int x_ind, int y_ind)
const
{
...
arma::mat trame::ltu::du_Psi(const arma::mat& U, const arma::mat& V)
const
{
...
arma::mat trame::ltu::du_Psi(const arma::mat& U, const arma::mat& V, arma::uvec* xs, arma::uvec* ys)
const
{
    arma::uvec x_ind = (xs) ? *xs : uvec_linspace(0, nbX-1);
    arma::uvec y_ind = (ys) ? *ys : uvec_linspace(0, nbY-1);
...
arma::mat trame::ltu::du_Psi(const double& U, const arma::mat& V, arma::uvec* xs, arma::uvec* ys)
const
{
    arma::uvec x_ind = (xs) ? *xs : uvec_linspace(0, nbX-1);
    arma::uvec y_ind = (ys) ? *ys : uvec_linspace(0, nbY-1);
...
arma::mat trame::ltu::du_Psi(const arma::mat& U, const double& V, arma::uvec* xs, arma::uvec* ys)
const
{
    arma::uvec x_ind = (xs) ? *xs : uvec_linspace(0, nbX-1);
    arma::uvec y_ind = (ys) ? *ys : uvec_linspace(0, nbY-1);
...
arma::mat trame::ltu::dtheta_Psi(const arma::mat& U, const arma::mat& V, const arma::mat& dtheta)
{
...
arma::mat trame::ltu::Ucal(const arma::mat& vs, arma::uvec* xs, arma::uvec* ys)
const
{
    arma::uvec x_ind = (xs) ? *xs : uvec_linspace(0, nbX-1);
    arma::uvec y_ind = (ys) ? *ys : uvec_linspace(0, nbY-1);
...
double trame::ltu::Ucal(const double& vs, int xs, int ys)
const
{
...
arma::mat trame::ltu::Vcal(const arma::mat& us)
const
{
...
arma::mat trame::ltu::Vcal(const arma::mat& us, arma::uvec* xs, arma::uvec* ys)
const
{
    arma::uvec x_ind = (xs) ? *xs : uvec_linspace(0, nbX-1);
    arma::uvec y_ind = (ys) ? *ys : uvec_linspace(0, nbY-1);
...
double trame::ltu::Vcal(const double& us, int xs, int ys)
const
{
...
arma::mat trame::ltu::UW(const arma::mat& Ws)
const
{
...
arma::mat trame::ltu::UW(const arma::mat& Ws, arma::uvec* xs, arma::uvec* ys)
const
{
    arma::uvec x_ind = (xs) ? *xs : uvec_linspace(0, nbX-1);
    arma::uvec y_ind = (ys) ? *ys : uvec_linspace(0, nbY-1);
...
double trame::ltu::UW(const double& Ws, int x_ind, int y_ind)
const
{
...
arma::mat trame::ltu::VW(const arma::mat& Ws)
const
{
...
arma::mat trame::ltu::VW(const arma::mat& Ws, arma::uvec* xs, arma::uvec* ys)
const
{
    arma::uvec x_ind = (xs) ? *xs : uvec_linspace(0, nbX-1);
    arma::uvec y_ind = (ys) ? *ys : uvec_linspace(0, nbY-1);
...
double trame::ltu::VW(const double& Ws, int x_ind, int y_ind)
const
{
...
arma::mat trame::ltu::dw_UW(const arma::mat& Ws)
const
{
...
arma::mat trame::ltu::dw_UW(const arma::mat& Ws, arma::uvec* xs, arma::uvec* ys)
const
{
    arma::uvec x_ind = (xs) ? *xs : uvec_linspace(0, nbX-1);
    arma::uvec y_ind = (ys) ? *ys : uvec_linspace(0, nbY-1);
...
arma::mat trame::ltu::dw_VW(const arma::mat& Ws)
const
{
...
arma::mat trame::ltu::dw_VW(const arma::mat& Ws, arma::uvec* xs, arma::uvec* ys)
const
{
    arma::uvec x_ind = (xs) ? *xs : uvec_linspace(0, nbX-1);
    arma::uvec y_ind = (ys) ? *ys : uvec_linspace(0, nbY-1);
...
arma::mat trame::ltu::WU(const arma::mat& Us)
{
...
arma::mat trame::ltu::WU(const arma::mat& Us, arma::uvec* xs, arma::uvec* ys)
{
    arma::uvec x_ind = (xs) ? *xs : uvec_linspace(0, nbX-1);
    arma::uvec y_ind = (ys) ? *ys : uvec_linspace(0, nbY-1);
    //
...
arma::mat trame::ltu::WV(const arma::mat& Vs)
{
...
arma::mat trame::ltu::WV(const arma::mat& Vs, arma::uvec* xs, arma::uvec* ys)
{
    arma::uvec x_ind = (xs) ? *xs : uvec_linspace(0, nbX-1);
    arma::uvec y_ind = (ys) ? *ys : uvec_linspace(0, nbY-1);
    //

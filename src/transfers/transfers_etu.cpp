...
void trame::transfers::etu::build(const arma::mat& alpha_ETU, const arma::mat& gamma_ETU, const arma::mat& tau_ETU, bool need_norm_ETU)
{
...
void trame::transfers::etu::trans()
{
    int nbX_temp = nbX;
...
arma::mat trame::transfers::etu::M(const arma::mat& a_xs, const arma::mat& b_ys)
const
{
...
arma::mat trame::transfers::etu::M(const arma::mat& a_xs, const arma::mat& b_ys, arma::uvec* xs, arma::uvec* ys)
const
{
...
arma::mat trame::transfers::etu::M(const double& a_xs, const arma::mat& b_ys, arma::uvec* xs, arma::uvec* ys)
const
{
...
arma::mat trame::transfers::etu::M(const arma::mat& a_xs, const double& b_ys, arma::uvec* xs, arma::uvec* ys)
const
{
    arma::uvec x_ind = (xs) ? *xs : uvec_linspace(0, (int) nbX-1); 
    arma::uvec y_ind = (ys) ? *ys : uvec_linspace(0, (int) nbY-1);
...
arma::mat trame::transfers::etu::Mx0(const arma::mat& a_x)
const
{
    return a_x;
}

arma::mat trame::transfers::etu::M0y(const arma::mat& b_y)
const
{
    return b_y;
}
...
arma::mat trame::transfers::etu::Psi(const arma::mat& U, const arma::mat& V)
const
{
...
arma::mat trame::transfers::etu::Psi(const arma::mat& U, const arma::mat& V, arma::uvec* xs, arma::uvec* ys)
const
{
    arma::uvec x_ind = (xs) ? *xs : uvec_linspace(0, nbX-1);
    arma::uvec y_ind = (ys) ? *ys : uvec_linspace(0, nbY-1);
...
arma::mat trame::transfers::etu::Psi(const double& U, const arma::mat& V, arma::uvec* xs, arma::uvec* ys)
const
{
    arma::uvec x_ind = (xs) ? *xs : uvec_linspace(0, nbX-1);
    arma::uvec y_ind = (ys) ? *ys : uvec_linspace(0, nbY-1);
...
arma::mat trame::transfers::etu::Psi(const arma::mat& U, const double& V, arma::uvec* xs, arma::uvec* ys)
const
{
    arma::uvec x_ind = (xs) ? *xs : uvec_linspace(0, nbX-1);
    arma::uvec y_ind = (ys) ? *ys : uvec_linspace(0, nbY-1);
...
double trame::transfers::etu::Psi(const double& U, const double& V, int x_ind, int y_ind)
const
{
...
arma::mat trame::transfers::etu::du_Psi(const arma::mat& U, const arma::mat& V)
const
{
...
arma::mat trame::transfers::etu::du_Psi(const arma::mat& U, const arma::mat& V, arma::uvec* xs, arma::uvec* ys)
const
{
    arma::uvec x_ind = (xs) ? *xs : uvec_linspace(0, nbX-1);
    arma::uvec y_ind = (ys) ? *ys : uvec_linspace(0, nbY-1);
...
arma::mat trame::transfers::etu::du_Psi(const double& U, const arma::mat& V, arma::uvec* xs, arma::uvec* ys)
const
{
    arma::uvec x_ind = (xs) ? *xs : uvec_linspace(0, nbX-1);
    arma::uvec y_ind = (ys) ? *ys : uvec_linspace(0, nbY-1);
...
arma::mat trame::transfers::etu::du_Psi(const arma::mat& U, const double& V, arma::uvec* xs, arma::uvec* ys)
const
{
    arma::uvec x_ind = (xs) ? *xs : uvec_linspace(0, nbX-1);
    arma::uvec y_ind = (ys) ? *ys : uvec_linspace(0, nbY-1);
...
arma::mat trame::transfers::etu::dtheta_Psi(const arma::mat& U, const arma::mat& V, const arma::mat& dtheta)
{
...
arma::mat trame::transfers::etu::Ucal(const arma::mat& vs)
const
{
...
arma::mat trame::transfers::etu::Ucal(const arma::mat& vs, arma::uvec* xs, arma::uvec* ys)
const
{
    arma::uvec x_ind = (xs) ? *xs : uvec_linspace(0, nbX-1);
    arma::uvec y_ind = (ys) ? *ys : uvec_linspace(0, nbY-1);
...
double trame::transfers::etu::Ucal(const double& vs, int xs, int ys)
const
{
...
arma::mat trame::transfers::etu::Vcal(const arma::mat& us)
const
{
...
arma::mat trame::transfers::etu::Vcal(const arma::mat& us, arma::uvec* xs, arma::uvec* ys)
const
{
    arma::uvec x_ind = (xs) ? *xs : uvec_linspace(0, nbX-1);
    arma::uvec y_ind = (ys) ? *ys : uvec_linspace(0, nbY-1);
...
double trame::transfers::etu::Vcal(const double& us, int xs, int ys)
const
{
...
arma::mat trame::transfers::etu::UW(const arma::mat& Ws)
const
{
...
arma::mat trame::transfers::etu::UW(const arma::mat& Ws, arma::uvec* xs, arma::uvec* ys)
const
{
    arma::uvec x_ind = (xs) ? *xs : uvec_linspace(0, nbX-1);
    arma::uvec y_ind = (ys) ? *ys : uvec_linspace(0, nbY-1);
...
double trame::transfers::etu::UW(const double& Ws, int x_ind, int y_ind)
const
{
...
arma::mat trame::transfers::etu::VW(const arma::mat& Ws)
const
{
...
arma::mat trame::transfers::etu::VW(const arma::mat& Ws, arma::uvec* xs, arma::uvec* ys)
const
{
    arma::uvec x_ind = (xs) ? *xs : uvec_linspace(0, nbX-1);
    arma::uvec y_ind = (ys) ? *ys : uvec_linspace(0, nbY-1);
...
double trame::transfers::etu::VW(const double& Ws, int x_ind, int y_ind)
const
{
...
arma::mat trame::transfers::etu::dw_UW(const arma::mat& Ws)
const
{
...
arma::mat trame::transfers::etu::dw_UW(const arma::mat& Ws, arma::uvec* xs, arma::uvec* ys)
const
{
    arma::uvec x_ind = (xs) ? *xs : uvec_linspace(0, nbX-1);
    arma::uvec y_ind = (ys) ? *ys : uvec_linspace(0, nbY-1);
...
arma::mat trame::transfers::etu::dw_VW(const arma::mat& Ws)
const
{
...
arma::mat trame::transfers::etu::dw_VW(const arma::mat& Ws, arma::uvec* xs, arma::uvec* ys)
const
{
    arma::uvec x_ind = (xs) ? *xs : uvec_linspace(0, nbX-1);
    arma::uvec y_ind = (ys) ? *ys : uvec_linspace(0, nbY-1);
...
arma::mat trame::transfers::etu::WU(const arma::mat& Us)
{
...
arma::mat trame::transfers::etu::WU(const arma::mat& Us, arma::uvec* xs, arma::uvec* ys)
{
    arma::uvec x_ind = (xs) ? *xs : uvec_linspace(0, nbX-1);
    arma::uvec y_ind = (ys) ? *ys : uvec_linspace(0, nbY-1);
    //
...
arma::mat trame::transfers::etu::WV(const arma::mat& Vs)
{
...
arma::mat trame::transfers::etu::WV(const arma::mat& Vs, arma::uvec* xs, arma::uvec* ys)
{
    arma::uvec x_ind = (xs) ? *xs : uvec_linspace(0, nbX-1);
    arma::uvec y_ind = (ys) ? *ys : uvec_linspace(0, nbY-1);
    //

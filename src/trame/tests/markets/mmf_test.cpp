 ...
 *
 * g++-mp-5 -O2 -Wall -std=c++11 -I/opt/local/include -I./../../headers -I/usr/local/include mmf_test.cpp -c -o mmf_test.o
 * g++-mp-5 -O2 -Wall -o mmf.test mmf_test.o -L/opt/local/lib -ltrame -framework Accelerate
 */

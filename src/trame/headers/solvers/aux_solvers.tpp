 ...
 *
 * This template function only works with empirical arums.
 *
 * Keith O'Hara
 * 08/23/2016
 */
...
template<typename Ta>
int build_disaggregate_epsilon (arma::vec n, Ta arums_emp_inp, arma::mat& epsilon_iy, arma::mat& epsilon0_i, arma::mat& I_ix)
{

...
// g++-mp-7 -O3 -Wall -std=c++11 -fopenmp -I./../../include fatter.cpp -o fatter.test -framework Accelerate -L./../.. -ltrame
...
int main()
{
    ...
    arma::mat mu_hat = arma::eye(nbX,nbY);
    ...
    double lambda = 0.58, val_hat_1, val_hat_2;

...
class logit
{
    public:
        ...
        ~logit(){};
         logit(){};
        explicit logit(const uint_t nbX_inp, const uint_t nbY_inp);
        explicit logit(const uint_t nbX_inp, const uint_t nbY_inp, const double sigma_inp, const bool outside_option_inp);

        void build(const uint_t nbX_inp, const uint_t nbY_inp);
        void build(const uint_t nbX_inp, const uint_t nbY_inp, const double sigma_inp, const bool outside_option_inp);
